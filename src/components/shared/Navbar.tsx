...
//   const link = <>
//    <li><Link className='text-[#CCFF00]' href='/workouts'>Workouts</Link></li>
  ...
  return (
    <nav className='container mx-auto'>
      <div className="navbar bg-base-100 shadow-sm px-4">
        ...
        {/* Navbar End: Plan & Saved Badges */}
        <div className="navbar-end flex items-center gap-4">
          {/* Plan Badge */}
          <Link href="/myplan" className="flex items-center gap-2 text-sm font-medium hover:opacity-80 transition-opacity">
            <span>Plan</span>
          ...
          {/* Saved Badge */}
          <Link href="/saved" className="flex items-center gap-2 text-sm font-medium hover:opacity-80 transition-opacity">
            <span>Saved</span>
